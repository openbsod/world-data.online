...
### master at commit e7942110cd53428d1533bba1a4b4a93ecaefeb2e (HEAD -> master, origin/master, origin/HEAD)
### Date:  Tue Jun 14 12:41:34 2022 -0700
...
Finally, create a new namespace for the the default user (named `world-data`).
